...
import { useParams } from "react-router-dom";import { ToastContainer, toast } from 'react-toastify';
...
export default function ProductDetailPage() {
    ...
    const addCartItem = async (product_id, qty) => {
        ...
        try {
            ...
            notify(`${res.data.data.product.title}${res.data.message}`);
        } catch (error) {
            alert('加入購物車失敗');
        } finally {
            setIsLoading(false);
                ...
                <div className="row">
                    ...
                    <div className="col-6">
                        ...
                        <div className="input-group align-items-center w-75">
                            ...
                            <button type="button" className="btn btn-outline-primary d-flex align-items-center gap-2" onClick={() => addCartItem(product_id, qtySelect)} disabled={isLoading}>
                                加入購物車
